        ...
        <div className="w-full h-full bg-white">
            <form onSubmit={addEmpresa}>
                ...
                <div className="md:flex md:flex-row mx-auto">
                    <div className="md:w-6/12 h-full flex flex-col items-center px-6 my-4 mx-auto">
                        ...
                        <div className="form-group w-full">
                            ...
                            <select className="form-control text-sm my-1 w-full p-2 border-2 shadow-md border-gray1 rounded-xl outline-none" value={form.localaidad} onChange={setForm} required name="localaidad">
                                {
                                    localidades?.map((e, i) => {
                                        return <option key={e.name + "," + i} value={`${e.id}`}>{e.name}</option>
                                    })
                    ...
                    <div className="md:w-6/12 h-flex flex flex-col items-center px-6 my-4 mx-auto">
                        ...
                        <div className="form-group w-full">
                            ...
                            <select className="form-control text-sm my-1 w-full p-2 border-2 shadow-md border-gray1 rounded-xl outline-none" name="activa" required onChange={setForm} value={form.activa}>
                                <option disabled={true} value="Estado">Estado?</option>
                ...
                <div className="flex justify-end content-end py-8 w-full">
                    <button className="bg-green1 text-white font-bold py-2 px-4 mx-2 rounded">Siguiente</button>
