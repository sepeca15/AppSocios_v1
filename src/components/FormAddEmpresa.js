...
const FormAddEmpresa = ({ InfoPageEmpresa = true }) => {
  ...
  const [form, setForm] = useForm({
    ...
    telefono: InfoPageEmpresa ? "" : detalleEmpresaActual?.telefono,
    nro_referencia: InfoPageEmpresa ? "" : detalleEmpresaActual?.nro_referencia,
    celular: InfoPageEmpresa ? "" : detalleEmpresaActual?.celular,
    direccion: InfoPageEmpresa ? "" : detalleEmpresaActual?.direccion,
    rut: InfoPageEmpresa ? "" : detalleEmpresaActual?.rut,
    email: InfoPageEmpresa ? "" : detalleEmpresaActual?.email,
    razon_social: InfoPageEmpresa ? "" : detalleEmpresaActual?.razon_social,
    nro_bps: InfoPageEmpresa ? "" : detalleEmpresaActual?.nro_bps,
    fecha_afiliacion: InfoPageEmpresa
      ? ""
      : detalleEmpresaActual?.fecha_afiliacion,
    fecha_inicio_empresa: InfoPageEmpresa
      ? ""
      : detalleEmpresaActual?.fecha_inicio_empresa,
    activa: InfoPageEmpresa ? false : detalleEmpresaActual?.activa,
    fecha_baja: InfoPageEmpresa ? "" : detalleEmpresaActual?.fecha_baja,
    observaciones: InfoPageEmpresa ? "" : detalleEmpresaActual?.observaciones,
    logo_empresa: InfoPageEmpresa
      ...
      : detalleEmpresaActual?.logo_empresa,
    localaidad: "",
  });
        ...
        <div className="w-10/12 flex flex-col items-center my-4 mx-auto">
          <p className="text-gray-800 text-center text-3x1 font-semibold">
            {InfoPageEmpresa
              ...
              : " Datos de " + detalleEmpresaActual?.nombre_fantasia}
          </p>
        </div>
