    ...
    return (
        <div className=" w-full mx-auto bg-white   h-auto transition-all duration-500 mb-2 border shadow-md border-grayBlack1">
            <div className="container flex p-4 justify-center items-center w-full h-full flex-wrap">
                ...
                <div className="z-50 absolute left-0 md:mt-0 mt-20   md:relative w-full md:w-auto h-16 bg-white md:bg-transparent border-red border-t-2  md:border-none bottom-0  flex flex-grow p-0 md:px-6 md:h-full items-center justify-around ">
